...
<form id="subform" class="layui-form layui-form-pane" name="itemForm" action="updateDict" method="post">
    <input type="hidden" id="id" name="id"  value="${itemDict.id}"/>
    <div for="value" class="layui-form-item" pane>
        ...
        <div class="layui-input-block">
            <input id="value" name="value"  lay-verify="value"
                   class="layui-input" type="text" value="${itemDict.value}" ></input>
        </div>
    </div>
    <div class="layui-form-item" pane>
        ...
        <div class="layui-input-block">
            <input id="label" name="label"  lay-verify="label"      class="layui-input"   autocomplete="off" value="${itemDict.label}"></input>
        </div>
    </div>
    <div class="layui-form-item" pane>
        ...
        <div class="layui-input-block">
            <input id="type" name="type"  lay-verify="type"   value="${itemDict.type}" readonly="readonly"   class="layui-input"   autocomplete="off"></input>
        </div>
    </div>
    <div class="layui-form-item" pane>
    ...
    <div class="layui-form-item" pane>
        ...
        <div class="layui-input-block">
            <input id="description" name="description"  lay-verify="description"  readonly="readonly"    class="layui-input"   autocomplete="off" value="${itemDict.description}"></input>
        </div>
    </div>
    <div class="layui-form-item" pane>
        ...
        <div class="layui-input-block">
            <input id="sort" name="sort"  lay-verify="sort"      class="layui-input"   autocomplete="off" value="${itemDict.sort}"></input>
        </div>
    </div>
    <div class="layui-form-item layui-form-text" pane>
        ...
        <div class="layui-input-block">
                <textarea id="remarks" name="remarks" lay-verify="remarks" readonly="readonly"
                          class="layui-textarea" placeholder="20字以上，500字以内">${itemDict.remarks}</textarea>
        </div>
...
<script>
    ...
    layui.use(['form', 'layer','laydate'], function (){
        ...
        form.on('submit(user)', function (data) {
            postAjaxre('updateDict', data.field, 'dictList');
            return false;
        });
    });
</script>
